...
@auth_router.post('/sms_confirmation', summary="Auth code")
...
@auth_router.get('/test_redis', summary="test redis connect (debug)")
async def get_users():
...
@auth_router.get('/get_users', summary="get all users (debug)")
async def get_users():
